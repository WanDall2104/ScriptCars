...
def configure_routes(app):
    ...
    @app.route('/veiculos_disponiveis')
    ...
    def novo_veiculo():
        ...
        try:
            ...
            if not marca or not modelo or not ano or not preco:
                ...
                return redirect(url_for('formulario_novo_veiculo'))
    ...
    @app.route('/veiculo/editar/<int:id>')
    @funcionario_required
    ...
    @app.route('/veiculo/editar/<int:id>', methods=['POST'])
    @funcionario_required
    def editar_veiculo(id):
        ...
        try:
            ...
            if not marca or not modelo or not ano or not preco:
                flash("Todos os campos são obrigatórios!", "error")
                return redirect(url_for('formulario_editar_veiculo', id=id))
